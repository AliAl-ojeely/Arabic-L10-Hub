...
export const fetchTranslationsData = async () => {
    const data = [
        ...
        },
        {
            ...
            translator: 'علي العجيلي',
            appVersion: 'v1.17.5',
            description: 'تعريب عربي شامل للعبة Men of War إصدار 1.17.5، يشمل ترجمة القوائم، الحوارات، المهمات، التعليمات، رسائل التحميل، وأجزاء واجهة المستخدم، مع دعم كامل لعرض الحروف العربية واتجاه النصوص من اليمين إلى اليسار (RTL)، وخطوط عربية مخصصة وتحسين ترتيب الأسطر والنصوص الصغيرة. تم اختبار التعريب ويعمل بكفاءة على دقتي 720p و1080p.',
            installationSteps: [
                'قم بتحميل ملف التعريب المضغوط (7z) من الزر أدناه.',
                'استخرج الملفات باستخدام أحد برامج فك الضغط مثل 7-Zip أو WinRAR.',
        ...
        },
        {
            ...
            translator: 'علي العجيلي',
            appVersion: 'v1.0',
            description: 'تعريب عربي شامل للعبة Jagged Alliance 3 يعمل من خلال نظام المودات الرسمي للعبة دون تعديل ملفات اللعبة الأصلية. يشمل التعريب القوائم والواجهات والحوارات والنصوص الداخلية، مع دعم عرض اللغة العربية والخطوط العربية. تأتي الحزمة مع مثبت آلي يقوم بوضع مود JA3 Arabic Lab في المسار الصحيح تلقائيًا، بالإضافة إلى أدوات مستقلة لإزالة مود التعريب فقط أو حذف جميع المودات والعودة إلى حالة نظيفة.',
            installationSteps: [
        ...
        },
        {
            ...
            translator: 'علي العجيلي',
            appVersion: 'v1.0.0',
            description: 'تعريب عربي شامل للعبة التحقيق والغموض Kill The Shadow، يشمل ترجمة القوائم والواجهات والحوارات والنصوص الداخلية بالكامل، مع دعم عرض اللغة العربية من اليمين إلى اليسار (RTL)، وخط عربي مخصص، ومعالجة التفاف الأسطر والعناوين الكبيرة، بالإضافة إلى تعريب الخرائط وعناوين المناطق وشاشات التحميل والشعارات والعناصر البصرية داخل اللعبة، بهدف تقديم تجربة عربية متكاملة قدر الإمكان.',
            installationSteps: [
                'قم بتحميل ملف التعريب المضغوط Kill_The_Shadow_Arabic_v1.0.0.zip من الزر أدناه.',
                'استخرج محتويات الحزمة باستخدام 7-Zip أو WinRAR.',
                'أغلق اللعبة بالكامل قبل تثبيت التعريب.',
